...
public class LocomotionTeleport : MonoBehaviour
{
	...
	public void DoTeleport()
	{
		...
		destRotation.eulerAngles = new Vector3(0, destRotation.eulerAngles.y, 0);
#if false
		...
		StartCoroutine(fadeIn(characterTransform, destPosition, destRotation));
	...
	public IEnumerator fadeIn(Transform characterTransform, Vector3 destPosition, Quaternion destRotation)
	{
